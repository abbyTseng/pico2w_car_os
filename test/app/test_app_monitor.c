...
{
    // 【修改】加入 HEARTBEAT_BIT_DIAG
    uint32_t bits = HEARTBEAT_BIT_FSM | HEARTBEAT_BIT_DISPLAY | HEARTBEAT_BIT_DIAG;
...
{
    // 【修改】有 Display 和 Diag，但缺少了 FSM
    uint32_t bits = HEARTBEAT_BIT_DISPLAY | HEARTBEAT_BIT_DIAG;
